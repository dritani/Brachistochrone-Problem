function test5()
% VARIATION 2: random initial shape
clearvars
clc
...
xlabel('X')
ylabel('Y')
title('Figure 8: Random initial shape')
legend('Final value','Initial value','100 iterations','250 iterations','500 iterations','2000 iterations','Cycloid')
